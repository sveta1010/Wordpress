...
Enhance your Gutenberg experience with **35+ unique blocks** (more coming soon). Add power to the block editor using our easy-to-use blocks which are designed to make your next WordPress page or posts design easier and prettier than ever before.
...
##35+ FREE BLOCKS AND COUNTING
Design without limits in WordPress block editor, using 35+ of the most useful Essential Blocks for Gutenberg.
...
= 3.7.2 - 17/10/2022 =
- Added: Add induvisual color option for **Accordion Toggle** items
