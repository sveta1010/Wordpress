                            ...
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="spai-inline-help">
                                        <span class="dashicons dashicons-editor-help" title="Inline help"
                                              data-link="https://shortpixel.com/knowledge-base/article/486-api-url"></span></div>
                                        <input
                                            type="text"
                                            name="api_url"
                                            data-type="string"
                                        ...
                                        />
                                        <p class="description">
                                            <?= __( 'Do <strong>not</strong> change this unless you plan on using your own CDN and you have already configured it to use the ShortPixel.ai service. Check out <a href="https://shortpixel.com/knowledge-base/article/180-can-i-use-a-different-cdn-with-shortpixel-adaptive-images" target="_blank">here</a> or <a href="https://shortpixel.com/knowledge-base/article/200-setup-your-stackpath-account-so-that-it-can-work-with-shortpixel-adaptive-images-api" target="_blank">here</a> for examples.',
                                                'shortpixel-adaptive-images' ); ?>
                                        </p>
                                        <div class="notification_popup hidden">
                                            <p class="text">
